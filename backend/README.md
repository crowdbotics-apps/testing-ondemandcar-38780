...
## Project Structure
    ...
    ├── testing_ondemandcar_38780  # Django project configurations
...
1. Clone this repo and `cd testing_ondemandcar_38780`
...
2. Clone this repo and `cd testing_ondemandcar_38780`
